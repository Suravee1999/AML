...
${1.1สัญชาติ_เลือก}     //mat-option[.//span[contains(text(),'${สัญชาติ}')]]
...
${ไม่มีข้อมูลในข้อ 1.3}        (//mat-checkbox[contains(@class, 'mat-checkbox')])[2]
...
${ไม่มีข้อมูลในข้อ 1.4}         (//mat-checkbox[contains(@class, 'mat-checkbox')])[3]
...
${ไม่มีข้อมูลในข้อ 2.3}        (//mat-checkbox[contains(@class, 'mat-checkbox')])[1]
...
${ไม่มีข้อมูลในข้อ 2.4}         (//mat-checkbox[contains(@class, 'mat-checkbox')])[2]
...
${3.2_บุคคลธรรมดา}   //mat-radio-button[.//span[contains(text(), 'บุคคลธรรมดา')]]
${3.2_นิติบุคคล}    //mat-radio-button[.//span[contains(text(), 'นิติบุคคล')]]
${3.2_คำนำหน้าชื่อ}         //mat-select[@name='sendPrefix']
${3.2_คำนำหน้าชื่อ_เลือก}       //mat-option[@ng-reflect-value='${คำนำหน้าส่วน3.2}']
...
${3.2_ระบุหมายเลข}       //input[@name='sendNo']
...
${3.2หลักฐานที่ใช้ในการทำธุรกรรม_CITIZENID}      //mat-radio-group[@name='senderEvidenceType']//mat-radio-button[@value='CITIZENID']
${3.2หลักฐานที่ใช้ในการทำธุรกรรม_PASSPORTNO}      //mat-radio-group[@name='senderEvidenceType']//mat-radio-button[@value='PASSPORTNO']
${3.2หลักฐานที่ใช้ในการทำธุรกรรม_TAXID}      //mat-radio-group[@name='senderEvidenceType']//mat-radio-button[@value='TAXID']
${3.2หลักฐานที่ใช้ในการทำธุรกรรม_ระบุ}      (//input[@name='eviSenderNo'])[1]

${3.3_บุคคลธรรมดา}   (//mat-radio-button[.//span[contains(text(), 'บุคคลธรรมดา')]])[2]
${3.3_นิติบุคคล}    (//mat-radio-button[.//span[contains(text(), 'นิติบุคคล')]])[2]
${3.3_คำนำหน้าชื่อ}         //mat-select[@name='recievePrefix']
${3.3_คำนำหน้าชื่อ_เลือก}       //mat-option[@ng-reflect-value='${คำนำหน้าส่วน3.3}']
${3.3_ชื่อ}         //input[@name='recieveFirstName']
${3.3_นามสกุล}      //input[@name='recieveLastName']
${3.3_หมายเลขที่ใช้ในการโอน_หมายเลขบัญชีที่ขอโอน}       (//mat-radio-button[.//span[contains(text(), 'หมายเลขบัญชีที่รับโอน')]])[1]
${3.3_หมายเลขที่ใช้ในการโอน_หมายเลขอ้างอิงเฉพาะในการโอนเงิน}    (//mat-radio-button[.//span[contains(text(), 'หมายเลขอ้างอิงเฉพาะในการรับโอนเงิน')]])[1]
${3.3_ระบุหมายเลข}      //input[@name='recieveNo']
...
${3.3หลักฐานที่ใช้ในการทำธุรกรรม_CITIZENID}      //mat-radio-group[@name='recieveEvidenceType']//mat-radio-button[@value='CITIZENID']
${3.3หลักฐานที่ใช้ในการทำธุรกรรม_PASSPORTNO}     //mat-radio-group[@name='recieveEvidenceType']//mat-radio-button[@value='PASSPORTNO']
${3.3หลักฐานที่ใช้ในการทำธุรกรรม_TAXID}      //mat-radio-group[@name='recieveEvidenceType']//mat-radio-button[@value='TAXID']
${3.3หลักฐานที่ใช้ในการทำธุรกรรม_ระบุ}     (//input[@name='eviRecieveNo'])[1]


${3.4วัตถุประสงค์ของการทำธุรกรรม}  xpath=//mat-select[@name='objectiveType']
