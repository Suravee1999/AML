...
Resource    keywords_Testcase_1-02.robot

*** Variables ***
#************************************* ยื่นคำร้อง Manual ****************************************************
${ประเภทรายงาน}     xpath=//mat-select[@aria-labelledby='mat-select-value-1']
${ปปง.1-02}     xpath=//mat-option[@ng-reflect-value='1-02']
...
#*****************ส่วนที่ 3 *************************
${ส่วนที่3_วันที่ทำธุรกรรม}       xpath=//input[contains(@class, 'mat-datepicker-input')]
${3.1_ประเภทธุรกรรม_จำนอง}      //mat-radio-button[.//span[contains(text(), 'จำนอง')]]
${3.1_ประเภทธุรกรรม_ขายฝาก}     //mat-radio-button[.//span[contains(text(), 'ขายฝาก')]]
${3.1_ประเภทธุรกรรม_โอนเงิน}    //mat-radio-button[.//span[contains(text(), 'โอนเงิน')]]
${3.1_ประเภทธุรกรรม_อื่นๆ}      (//mat-radio-button[label/span[contains(text(), 'อื่นๆ')]])[1]
${3.1_ประเภทธุรกรรม_อื่นๆ_ระบุ}     //input[@ng-reflect-maxlength="80"]
${3.2_ประเภททรัพย์สินที่ใช้ทําธุรกรรม_ที่ดิน}       //mat-radio-button[label/span[contains(text(), 'ที่ดิน')]]
${3.2_ประเภททรัพย์สินที่ใช้ทําธุรกรรม_ที่ดินและสิ่งปลูกสร้าง}       //mat-radio-button[label/span[contains(text(), 'ที่ดินและสิ่งปลูกสร้าง')]]
${3.2_ประเภททรัพย์สินที่ใช้ทําธุรกรรม_สิ่งปลูกสร้าง}        //mat-radio-button[label/span[contains(text(), 'สิ่งปลูกสร้าง')]]
${3.2_ประเภททรัพย์สินที่ใช้ทําธุรกรรม_อื่นๆ}    (//mat-radio-button[label/span[contains(text(), 'อื่นๆ')]])[2]
${3.2_ประเภททรัพย์สินที่ใช้ทําธุรกรรม_อื่นๆ_ระบุ}    xpath=//input[@ng-reflect-name='assetDesc']
${3.2_โปรดระบุรายละเอียดของทรัพย์สิน}       //textarea[contains(@class, 'mat-input-element')]
${3.3_มูลค่าทรัพย์สินที่ทำธุรกรรมทั้งสิ้น}      //input[@name='assetAmount']
${3.4_บัญชีที่ทำธุรกรรม_เลขที่บัญชีที่ทำธุรกรรม}       //input[@name="accountNo"]
${3.4_บัญชีที่ทำธุรกรรม_ชื่อบัญชี}                  //input[@ng-reflect-name='accountName']
${3.4_บัญชีที่ทำธุรกรรม_ชื่อเจ้าของบัญชี_บุคคลธรรมดา}   (//mat-radio-button[@value='1'])[3]
${3.4_บัญชีที่ทำธุรกรรม_ชื่อเจ้าของบัญชี_นิติบุคคล}     (//mat-radio-button[@value='2'])[3]
${3.4_บัญชีที่ทำธุรกรรม_คำนำหน้าชื่อ}               xpath=//mat-select[@name='accountHolderPrefix']
${3.4_บัญชีที่ทำธุรกรรม_คำนำหน้าชื่อ_เลือก}         xpath=//mat-option[@ng-reflect-value='${คำนำหน้าส่วน3.4}']
${3.4_บัญชีที่ทำธุรกรรม_คำนำหน้าชื่อ_ชื่อ}          (//input[@name='accountHolderFirst'])[1]
${3.4_บัญชีที่ทำธุรกรรม_คำนำหน้าชื่อ_ชื่อกลาง}      (//input[@name='accountHolderMiddle'])[1]
${3.4_บัญชีที่ทำธุรกรรม_คำนำหน้าชื่อ_นามสกุล}       (//input[@name='accountHolderLast'])[1]
${3.5}
${3.5}
${3.5}
${3.5}
...
${3.7วัตถุประสงค์ของการทำธุรกรรม}  xpath=//mat-select[@name='objectiveType']
${3.7วัตถุประสงค์ของการทำธุรกรรม_เลือก}    //mat-option[.//span[contains(text(), '${เลือกวัตถุประสงค์ของการทำธุรกรรม}')]]
