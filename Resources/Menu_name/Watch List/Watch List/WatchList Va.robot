...
${% ความแม่นยำในการค้นหา_90}       //mat-radio-button[.//span[contains(normalize-space(.), '90%')]]
${% ความแม่นยำในการค้นหา_100}       //mat-radio-button[.//span[contains(normalize-space(.), '100%')]]
${เลขบัตรประจำตัวประชาชน_xpath}     //input[@name='idPassportNo']
${เลขทะเบียนการค้า/เลขประจำตัวผู้เสียภาษี_xpath}     //input[@name='copind']
