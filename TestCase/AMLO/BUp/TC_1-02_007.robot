...
10.เปลี่ยนUserอนุมัติข้อมูลระดับฝ่ายกำกับพนักงาน
        ออกจากระบบ
...
11.เปลี่ยนUserอนุมัติข้อมูลระดับฝ่ายกำกับหัวหน้างาน
        ออกจากระบบ
        เข้าด้วยUserระดับฝ่ายกำกับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกส่งขออนุมัติ
12.เปลี่ยนUserส่งกลับระดับหัวหน้าฝ่ายกำกับ
        ออกจากระบบ
...
13.เปลี่ยนUserส่งกลับระดับฝ่ายกำกับหัวหน้างาน
        ออกจากระบบ
        เข้าด้วยUserระดับฝ่ายกำกับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
14.เปลี่ยนUserส่งกลับระดับฝ่ายกำกับพนักงาน
        ออกจากระบบ
        เข้าด้วยUserระดับฝ่ายกำกับพนักงาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
15.เปลี่ยนUserส่งกลับระดับหัวหน้างาน
        ออกจากระบบ
        เข้าด้วยUserระดับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
16.แก้ไขข้อมูลระดับพนักงาน
        ออกจากระบบ
        เข้าด้วยUserระดับพนักงาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        ...
        ส่วนที่ 3 บันทึกข้อมูล
        ส่วนที่ 3 ขออนุมัติ
17.เปลี่ยนUserอนุมัติข้อมูลระดับผู้จัดการ
        ออกจากระบบ
        เข้าด้วยUserระดับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกอนุมัติรายการ
18.เปลี่ยนUserอนุมัติข้อมูลระดับฝ่ายกำกับพนักงาน
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งขออนุมัติ
19.เปลี่ยนUserอนุมัติข้อมูลระดับฝ่ายกำกับหัวหน้างาน
       [Documentation]     ฝ่ายกำกับหัวหน้างานอนุมัติข้อมูลรายการ
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งขออนุมัติ
20.เปลี่ยนUserอนุมัติข้อมูลระดับหัวหน้าฝ่ายกำกับ
