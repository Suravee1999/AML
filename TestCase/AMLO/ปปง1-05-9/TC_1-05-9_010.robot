...
Documentation       ทดสอบการยื่นคำร้อง manual ของ ปปง.1-05-9  TC_1-05-9_010
*** Variables ***
...
9.เปลี่ยนUserเลือกส่งกลับคืนเพื่อแก้ไขระดับฝ่ายกำกับพนักงาน
        [Documentation]     เข้าUser ฝ่ายกำกับพนักงานเลือกส่งกลับคืนเพื่อแก้ไขอนุมัติข้อมูลรายการ
        ออกจากระบบ
        เข้าด้วยUserระดับฝ่ายกำกับพนักงาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
...
10.เปลี่ยนUserเลือกส่งกลับคืนเพื่อแก้ไขระดับผู้จัดการ
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
11.แก้ไขข้อมูลUserระดับพนักงาน
