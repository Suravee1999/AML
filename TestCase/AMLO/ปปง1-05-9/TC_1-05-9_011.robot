...
Documentation       ทดสอบการยื่นคำร้อง manual ของ ปปง.1-05-9  TC_1-05-9_011
*** Variables ***
...
7.เปลี่ยนUserอนุมัติข้อมูลระดับฝ่ายกำกับพนักงาน
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งขออนุมัติ
8.เปลี่ยนUserเลือกส่งกลับคืนเพื่อแก้ไขระดับฝ่ายกำกับหัวหน้างาน
        [Documentation]     ข้าUser ฝ่ายกำกับหัวหน้างานเลือกส่งกลับคืนเพื่อแก้ไข
        ออกจากระบบ
        เข้าด้วยUserระดับฝ่ายกำกับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
9.เปลี่ยนUserเลือกส่งกลับคืนเพื่อแก้ไขระดับฝ่ายกำกับพนักงาน
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
10.เปลี่ยนUserเลือกส่งกลับคืนเพื่อแก้ไขระดับผู้จัดการ
        ...
        ค้นหารายงานด้วย CIF
        เลือกส่งกลับคืนเพื่อแก้ไข
11.เข้าระบบด้วยพนักงานและแก้ไขข้อมูล
...
12.เปลี่ยนUserอนุมัติข้อมูลระดับผู้จัดการ
        [Documentation]     เข้าUser ระดับผู้จัดการอนุมัติข้อมูล
        ออกจากระบบ
        เข้าด้วยUserระดับหัวหน้างาน
        เลือกเมนูView Alert รายงาน ปปง. 1-01, 1-02, 1-03, 1-05-9
