...
*** Variables ***
${Source}               #AMLO,CFRI,Down Jones,GSB
${เลขบัตรประจำตัวประชาชน}           1991684729125
${ตรวจสอบด้วย ชื่อภาษาไทย ชื่อ}     ณัฐรัตน์
${ตรวจสอบด้วย ชื่อภาษาไทย ชื่อกลาง}
${ตรวจสอบด้วย ชื่อภาษาไทย นามสกุล}      จันเกษม
...
3.ระบุข้อมูลตรวจสอบเลขบัตร
        [Documentation]   ตรวจสอบข้อมูลWatchlist ด้วยเลขที่บัตร
