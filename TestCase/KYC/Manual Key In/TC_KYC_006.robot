...
Documentation    ทดสอบการทำงาน KYC  TC_KYC_006
...
${ประเทศที่นิติบุคคลตั้งอยู่}    TH ไทย
${เป็นบริษัทที่จดทะเบียนในตลาด}     Y YES   #YES / NO
${โครงสร้างถือหุ้นมีความผิดปกติ}    โครงสร้างการถือหุ้นไม่มีความผิดปกติ   #โครงสร้างการถือหุ้นมีความผิดปกติ /โครงสร้างการถือหุ้นไม่มีความผิดปกติ
${ตรวจสอบพบว่านิติบคคลมีตัวแทน}   ตรวจสอบพบว่านิติบุคคลที่มีตัวแทน      #ตรวจสอบพบว่านิติบุคคลที่มีตัวแทน/ตรวจสอบพบว่านิติบุคคลไม่มีตัวแทน
...
1.open web IBank & Login
        [Documentation]   ทดสอบการทำงาน KYC Manual Key in TC_KYC_006
