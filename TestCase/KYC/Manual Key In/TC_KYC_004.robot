...
Documentation    ทดสอบการทำงาน KYC  TC_KYC_004
*** Variables ***
...
${สัญชาติ}      KP เกาหลีเหนือ
${ประเทศที่อยู่}    KP เกาหลีเหนือ
${เป็นลูกค้าที่ไม่มีถิ่นที่อยู่ในประเทศไทย}     YES   #YES / NO
${สาขาเจ้าของบัญชี}     003600
...
1.open web IBank & Login
        [Documentation]   ทดสอบการทำงาน KYC Manual Key in TC_KYC_004
...
5.ยืนยันการอนุมัติ KYC
        ...
        กดปุ่มส่งเมล
        กดปุ่มรอตรวจสอบ
6.ออกจากระบบเข้า User ผู้จัดการเข้าอนุมัติข้อมูล
        ออกจากระบบ
